Shader "Custom/BurningOutlineShader"
{
    Properties
    {
        ...
        _GradientPow ("Gradient Power", Float) = 0.7
        _GradientThickness ("Gradient Thickness", Float) = 3.0
        _EdgePow ("Edge Power", Float) = 10
        _Hight ("Flame Hight", Float) = 1.0
        _Edge ("Rim Strength", Float) = 0.7
        _Shininess ("Rim Shininess", Float) = 1.8
